...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post websites_url, params: { website: { username: @website.username, website_address: @website.website_address } }
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { username: @website.username, website_address: @website.website_address } }
